package com.test.busapi.core.repository;

import com.test.busapi.core.entity.BaseEntity;
...
public interface BaseRepository<T extends BaseEntity> extends JpaRepository<@NonNull T, @NonNull Long> {
